...
public class p4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("UPDATE PLAYER INFORMATION"));
    ...
    private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
        ...
        {	
         ...
         Statement s1=c1.createStatement();
            String q1="Update player set name='"+t2.getText()+"'’where playeridno="+t1.getText()+";";                
             s1.executeUpdate(q1);
            s1.close();
            c1.close();
        }
